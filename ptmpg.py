...
def cnf():
    if mobno_inp.get() == "":
        messagebox.showerror("Error", "Please Enter A Mobile No\nOr\nEnter Mobile No For Verification")
    else:
        messagebox.showinfo("Success",
                            "If Delivery: Your Order will be Delivered In Next 30 Minutes\nIf Pickup: You Can Pickup Your Order In Next 30 Minutes")
...
root1.logo = PhotoImage(file="paytm.png")
...
pop_number = Label(root1, font=('arial', 8, 'bold'), text="*Click On Confirm After Successfully Payment On Paytm By Barcode", bd=16, anchor='w')
pop_number.place(x=0, y=575)


customer_number = Label(root1, font=('arial', 16, 'bold'), text="Mobile No.", bd=16, anchor='w')
customer_number.place(x=120, y=1)

txt_customer = Entry(root1, font=('arial', 16, 'bold'), textvariable=mobno_inp, bd=10, insertwidth=4, bg="powder blue", justify ='right')
